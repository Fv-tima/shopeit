  ...
  return (
    <div>
      ...
      <div className="p-[40px]">
        ...
        <div className="flex flex-col md:flex-row space-x-16 justify-center items-center space-y-6 md:space-y-0 mt-4">
          <Image
            src={product.img}
            alt='images'
            width={530}
          ...
          <div className="flex flex-col gap-y-8">
            ...
            <div className="flex space-x-2 text-md"><button className="px-2 bg-black text-white rounded-md" onClick={() => increaseCartQuantity(product.id)}>+</button><span>1</span><button className="px-2 bg-black text-white rounded-md" onClick={() => increaseCartQuantity(product.id)}>-</button>
            </div>
