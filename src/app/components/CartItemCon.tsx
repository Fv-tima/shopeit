...
export default function CartItem({ id, quantity }: CartItemProps) {
  ...
  return (
    <div>
      <div className="md:flex hidden border-b-2 border-b-gray-400 items-center ">
        <div className="flex md:flex-row flex-col p-2 justify-center items-center gap-x-2 gap-y-2  md:w-[258px]  ">
          <Image
            src="/tick.svg"
            width={24}
            height={24}
      ...
      <div className="flex md:hidden border rounded-lg md:rounded-none  border-gray-400 justify-between w-full items-center p-4 m-2 ">
        <Image
          src="/tick.svg"
          width={24}
          height={24}
