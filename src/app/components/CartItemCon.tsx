  ...
  return (
    <div>
      <div className="lg:flex hidden border-b-2 border-b-gray-400 items-center ">
        ...
        <div className=" w-[86px] pl-2"><div className="flex space-x-2 text-md "><button className=" text-sm px-2 bg-black text-white rounded-md" onClick={() => decreaseCartQuantity(item.id)}>-</button><span>{quantity}</span><button className="px-2 text-sm bg-black text-white rounded-md" onClick={() => increaseCartQuantity(item.id)}>+</button>
        </div></div>
