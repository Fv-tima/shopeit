...
export default function ShoppingCart() {
  ...
  const delivery = cartQuantity >= 1 ?  45 : 0
  ...
  return (
    <div >
      ...
      <div className="flex lg:flex-row flex-col w-full h-full p-8 justify-center items-center lg:items-start gap-x-14">
      <div className="flex flex-col  justify-center rounded-full ">
      {cartQuantity >= 1 &&
      <div className="hidden lg:flex text-[#FBFBFC] h-20 px-2 items-center bg-[#251f73] font-[500] text-[20px]  rounded-md">
          ...
          <h1 className="w-[50px] md:w-[96px] pl-4" >Price</h1>
    ...
    <div className="flex  justify-between w-full">
      ...
      <h1 className="font-[400] text-[16px]">${delivery}</h1>
    </div>
    <div className="flex  justify-between w-full">
      <h1 className="text-gray-400 font-[400] text-[16px]">Total</h1>
      <h1 className="font-[400] text-[16px]">${total + delivery}</h1>
    </div>
    <Link href="/checkout">
